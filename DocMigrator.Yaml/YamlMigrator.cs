...
public class YamlMigrator
{
    ...
    //
    // /// <summary>
    // ///     Deserializes the specified Yaml element into an instance of type <typeparamref name="T" /> and applies migrations.
    // /// </summary>
    // /// <typeparam name="T">The type of the object to deserialize.</typeparam>
    // /// <param name="root">The Yaml element to deserialize.</param>
    // /// <returns>
    // ///     A <see cref="ValueTask{TResult}" /> representing the asynchronous operation, containing the deserialized
    // ///     object.
    // /// </returns>
    // public ValueTask<T?> Deserialize<T>(object root) where T : class
    // {
    //     var migrator = _serviceProvider.GetRequiredService<YamlMigrationDeserializer<T>>();
